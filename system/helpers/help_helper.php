...
function BuatKode(){
  ...
  $sql_kode = mysqli_query($conn, "SELECT RIGHT(no_rekamedis,5) AS kode FROM tb_data_pasien ORDER BY id_data_pasien DESC LIMIT 1");
