...
<div class="x_panel">
    ...
    <table id="datatable" class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <td>
                <a href="#" data-toggle="modal" data-target="#ModalEdit<?php echo $key->id_pegawai;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                <?php include 'modal-edit.php';?>
                <a href="#" data-toggle="modal" data-target="#ModalDelete<?php echo $key->id_pegawai;?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
    ...
    <div class="card card-small mb-4">
        ...
        <table class="table mb-0 table-responsive">
            ...
            <tr>
                ...
                <!-- <a href="#" data-toggle="modal" data-target="#ModalEdit<?php //echo $key->id_pegawai;?>" class='btn btn-outline-warning' >Edit</a>
                <?php //include 'modal-edit.php';?>
                <a href="#" data-toggle="modal" data-target="#ModalDelete<?php // echo $key->id_pegawai;?>" class='btn btn-outline-danger' >Delete</a>
                <?php //include 'modal-delete.php';?>
                </td>
            </tr> 
            <?php //$i++;?>
