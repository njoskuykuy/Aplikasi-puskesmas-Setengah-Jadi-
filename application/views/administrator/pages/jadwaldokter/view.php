...
<div class="x_panel">
    ...
    <table id="datatable" class="table table-striped table-bordered">
        ...
        <th scope="col" class="border-0">No</th>
                ...
                <th scope="col" class="border-0">Jam Mulai</th>
                <th scope="col" class="border-0">Jam Selesai</th>
        ...
        <tbody>
        <?php $i = 1;?>
        <?php foreach ($this->data['DT_Jadwal_Dokter'] as $key):?>
        <tr>
            <td><?php echo $i;?></td>
            ...
            <td>
                <a href="#" data-toggle="modal" data-target="#ModalEdit<?php echo $key->id_jadwal_dokter;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                <?php include 'modal-edit.php';?>
                <a href="#" data-toggle="modal" data-target="#ModalDelete<?php echo $key->id_jadwal_dokter;?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
    ...
    <div class="card card-small mb-4">
        ...
        <table class="table mb-0 table-responsive">
            ...
            <tr>
                ...
                <!-- <a href="#" data-toggle="modal" data-target="#ModalEdit<?php //echo $key->id_jadwal_dokter;?>" class='btn btn-outline-warning' >Edit</a>
                <?php //include 'modal-edit.php';?>
                <a href="#" data-toggle="modal" data-target="#ModalDelete<?php // echo $key->id_jadwal_dokter;?>" class='btn btn-outline-danger' >Delete</a>
                <?php //include 'modal-delete.php';?>
                </td>
            </tr> 
            <?php //$i++;?>
