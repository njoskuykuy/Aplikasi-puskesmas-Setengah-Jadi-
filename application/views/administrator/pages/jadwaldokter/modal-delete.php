<!-- Modal -->
<div class="modal fade" id="ModalDelete<?php echo $key->id_jadwal_dokter;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form action="?" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <h4>Apakah anda yakin ingin menghapus data <strong><?php echo $key->nama_dokter;?></strong> ??</h4>
        </div>
