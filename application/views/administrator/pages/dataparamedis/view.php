...
<div class="x_panel">
    ...
    <table id="datatable" class="table table-striped table-bordered">
        ...
        <th scope="col" class="border-0">No</th>
                <th scope="col" class="border-0">Kode Paramedis</th>
                <th scope="col" class="border-0">Nama Paramedis</th>
                <th scope="col" class="border-0">Jenis Kelamin</th>
                <th scope="col" class="border-0">No Izin Paramedis</th>
        ...
        <tbody>
        <?php $i = 1;?>
        <?php foreach ($this->data['DT_paramedis'] as $key):?>
        <tr>
            <td><?php echo $i;?></td>
            <td><?php echo $key->kd_paramedis;?></td>
            <td><?php echo $key->nama_paramedis;?></td>
            <td><?php echo $key->jenis_kelamin;?></td>
            <td><?php echo $key->no_izin_paramedis;?></td>
            <td><?php echo $key->tempat_lahir;?></td>
            <td><?php echo $key->tanggal_lahir;?></td>
            <td><?php echo $key->alamat;?></td>
            <td><?php echo $key->nama_poli;?></td>
            <td>
                <a href="#" data-toggle="modal" data-target="#ModalEdit<?php echo $key->id_paramedis;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                <?php include 'modal-edit.php';?>
                <a href="#" data-toggle="modal" data-target="#ModalDelete<?php echo $key->id_paramedis;?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
    ...
    <div class="card card-small mb-4">
        ...
        <table class="table mb-0 table-responsive">
            ...
            <tr>
                ...
                <!-- <a href="#" data-toggle="modal" data-target="#ModalEdit<?php //echo $key->id_paramedis;?>" class='btn btn-outline-warning' >Edit</a>
                <?php //include 'modal-edit.php';?>
                <a href="#" data-toggle="modal" data-target="#ModalDelete<?php // echo $key->id_paramedis;?>" class='btn btn-outline-danger' >Delete</a>
                <?php //include 'modal-delete.php';?>
                </td>
            </tr> 
            <?php //$i++;?>
